...
const MedicinaScreen = () => {
  return (
    ...
    <View style={styles.containerImg}>
        <Image source={require('../../../res/img/medicina/image1.png')} style={styles.image} />
    </View>
      ...
      <View style={styles.card}>
      <View style={styles.containerImg}>
        <Image source={require('../../../res/img/medicina/image2.png')} style={styles.image} />
        </View>
        <View style={styles.textContainer}>
      ...
      <View style={styles.card}>
      <View style={styles.containerImg}>
        <Image source={require('../../../res/img/medicina/image3.png')} style={styles.image} />
        </View>
        <View style={styles.textContainer}>
      ...
      <View style={styles.newsContainer}>
        <Image source={require('../../../res/img/medicina/biologia.png')} style={styles.subjectImage} />
      ...
      <View style={styles.subjectContainer}>
        <Image source={require('../../../res/img/medicina/fisica.png')} style={styles.subjectImage} />
        <View style={styles.contentContainer}>
      ...
      <View style={styles.subjectContainer}>
        <Image source={require('../../../res/img/medicina/quimica.png')} style={styles.subjectImage} />
        <View style={styles.contentContainer}>
      ...
      <View style={styles.subjectContainer}>
       <Image source={require('../../../res/img/medicina/lp.png')} style={styles.subjectImage} />
        <View style={styles.contentContainer}>
      ...
      <View style={styles.subjectContainer}>
        <Image source={require('../../../res/img/medicina/ingles.png')} style={styles.subjectImage} />
        <View style={styles.contentContainer}>
